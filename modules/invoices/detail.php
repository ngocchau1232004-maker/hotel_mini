<?php
    ...
    //Danh sách dịch vụ
    $services=mysqli_query($conn,"SELECT
                                    s.service_name,
                                    s.price,
                                    su.quantity,
                                    su.usage_date
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td> <?= $s['quantity'] ?> </td>
                            <td> <?= date("d/m/Y H:i",strtotime($s['usage_date'])) ?></td>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table">
                <tr>
                    <th>Tiền phòng</th>
                    <td class="text-end"><?= number_format($invoice['room_total']) ?> đ </td>
                </tr>

                <tr>
                    <th>Tiền dịch vụ</th>
                    <td class="text-end"><?= number_format($invoice['service_total']) ?> đ</td>
                </tr>
